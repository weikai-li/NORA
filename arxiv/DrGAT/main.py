...
def main():
    ...
    argparser.add_argument("--cycle", type=int, default=1, help="cycle", choices=[0, 1, 2, 3, 4])
    ...
    offset = len(all_idx) * (args.cycle) / 5
    offset = int(offset)
    ...
    for i in range(args.seed, args.seed + args.n_runs):
        seed(args.seed + i)
