...
python main.py --gpu 0 --use-norm --no-attn-dst --edge-drop=0.5 --input-drop=0.35 --cycle 1 \
    --n-layers 3 --dropout 0.8 --hid-drop 0.8 --n-hidden 128 --save kd --backbone drgat --mode teacher
python main.py --gpu 0 --use-norm --no-attn-dst --edge-drop=0.5 --input-drop=0.35 --cycle 1 \
    --n-layers 3 --dropout 0.8 --hid-drop 0.8 --n-hidden 128 --save kd --backbone drgat --alpha 0.95 --temp 0.7 --mode student

python main.py --gpu 0 --use-norm --no-attn-dst --edge-drop=0.5 --input-drop=0.35 --cycle 2 \
    --n-layers 3 --dropout 0.8 --hid-drop 0.8 --n-hidden 128 --save kd --backbone drgat --mode teacher
python main.py --gpu 0 --use-norm --no-attn-dst --edge-drop=0.5 --input-drop=0.35 --cycle 2 \
    --n-layers 3 --dropout 0.8 --hid-drop 0.8 --n-hidden 128 --save kd --backbone drgat --alpha 0.95 --temp 0.7 --mode student

python main.py --gpu 0 --use-norm --no-attn-dst --edge-drop=0.5 --input-drop=0.35 --cycle 3 \
    --n-layers 3 --dropout 0.8 --hid-drop 0.8 --n-hidden 128 --save kd --backbone drgat --mode teacher
python main.py --gpu 0 --use-norm --no-attn-dst --edge-drop=0.5 --input-drop=0.35 --cycle 3 \
    --n-layers 3 --dropout 0.8 --hid-drop 0.8 --n-hidden 128 --save kd --backbone drgat --alpha 0.95 --temp 0.7 --mode student

python main.py --gpu 0 --use-norm --no-attn-dst --edge-drop=0.5 --input-drop=0.35 --cycle 4 \
    --n-layers 3 --dropout 0.8 --hid-drop 0.8 --n-hidden 128 --save kd --backbone drgat --mode teacher
python main.py --gpu 0 --use-norm --no-attn-dst --edge-drop=0.5 --input-drop=0.35 --cycle 4 \
    --n-layers 3 --dropout 0.8 --hid-drop 0.8 --n-hidden 128 --save kd --backbone drgat --alpha 0.95 --temp 0.7 --mode student