...
python main.py --method gcn-e --model GAT_edge --dataset ogbn-arxiv --lr 3e-3 --wd 1e-5 --num_epochs 200 \
    --pred_hidden 128 --pred_num_layers 4 --pred_dropout 0.3 --train_ratio 0.15 --val_ratio 0.05
python evaluate.py --method gcn-e --model GAT_edge --dataset ogbn-arxiv --train_ratio 0.15 --val_ratio 0.05
